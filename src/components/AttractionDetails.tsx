...
function AttractionDetails({ attractions, index , mobile}) {
  ...
  return (<div>
    {mobile && (<div className="bg-neutral-100 shadow-lg bounded-xl h-300 col-span-2 bg-clip-border p-10 over">
    ...
    {!mobile && (<div className="bg-neutral-100 shadow-lg bounded-xl h-100 col-span-2 bg-clip-border p-10 over">
      <div className="font-sans font-bold">{attraction.name} </div>
      <div className="font-normal font-sans ">
        {attraction.amenity}
        <div className="text-sm text-neutral-500 font-sans">
